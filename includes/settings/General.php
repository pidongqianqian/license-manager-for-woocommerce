...
class General
{
    ...
    public function fieldEnabledApiRoutes()
    {
        ...
        $routes = array(
            ...
            // array(
            //     'id'         => '011',
            //     'name'       => 'v2/licenses/{license_key} - [Discarded]',
            //     'method'     => 'GET',
            //     'deprecated' => false,
            // ),
            array(
                'id'         => '011',
                'name'       => 'v2/nodefy-licenses/detail/?license_key={license_key}',
                'method'     => 'GET',
                'deprecated' => false,
            ),
            // array(
            ...
            // array(
            //     'id'         => '014',
            //     'name'       => 'v2/licenses/activate/{license_key} - [Discarded]',
            //     'method'     => 'GET',
            //     'deprecated' => false,
            // ),
            array(
                'id'         => '014',
                'name'       => 'v2/nodefy-licenses/activate/?license_key={license_key}&homeserver={homeserver}',
                'method'     => 'GET',
                'deprecated' => false,
            ),
            // array(
            //     'id'         => '015',
            //     'name'       => 'v2/licenses/deactivate/{license_key} - [Discarded]',
            //     'method'     => 'GET',
            //     'deprecated' => false,
            // ),
            array(
